    ...
    <div className="section-end page-shell">
      <section className="hero-gradient hero-under-nav pb-12 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 hero-entrance">
          <h1 className="heading-secondary mb-2 animate-fade-in-up">Case Studies</h1>
          <p className="text-slate-400 mt-2 max-w-xl mx-auto animate-fade-in-up">Real-world AI deployments and the outcomes they delivered.</p>
        </div>
      </section>
            ...
            {items.map(c=>(
              <div key={c.id} className="card flex flex-col overflow-hidden">
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="mt-4">
                    <Link to={`/case-studies/${c.id}`} className="inline-flex items-center gap-1.5 text-indigo-400 hover:text-indigo-300 text-sm font-medium link-hover-lift">
